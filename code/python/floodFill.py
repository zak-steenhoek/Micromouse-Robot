    ...
    if (x == x1):
        if (y > y1):
            if (cells[y][x] == 4 or cells[y][x] == 5 or cells[y][x] == 6 or cells[y][x] == 10 or cells[y][x] == 11 or
                    cells[y][x] == 12 or cells[y][x] == 14 or cells[y1][x1] == 2 or cells[y1][x1] == 7 or cells[y1][
                        x1] == 8 or cells[y1][x1] == 10 or cells[y1][x1] == 12 or cells[y1][x1] == 13 or cells[y1][
                        x1] == 14):
                return (False)
            else:
                return (True)
            ...
            if (cells[y][x] == 2 or cells[y][x] == 7 or cells[y][x] == 8 or cells[y][x] == 10 or cells[y][x] == 12 or
                    cells[y][x] == 13 or cells[y][x] == 14 or cells[y1][x1] == 4 or cells[y1][x1] == 5 or cells[y1][
                        x1] == 6 or cells[y1][x1] == 10 or cells[y1][x1] == 11 or cells[y1][x1] == 12 or cells[y1][
                        x1] == 14):
                return (False)
            else:
                return (True)
        ...
        if (x > x1):
            if (cells[y][x] == 1 or cells[y][x] == 5 or cells[y][x] == 8 or cells[y][x] == 9 or cells[y][x] == 11 or
                    cells[y][x] == 13 or cells[y][x] == 14 or cells[y1][x1] == 3 or cells[y1][x1] == 6 or cells[y1][
                        x1] == 7 or cells[y1][x1] == 9 or cells[y1][x1] == 11 or cells[y1][x1] == 12 or cells[y1][
                        x1] == 13):
                return (False)
            else:
                return (True)
            ...
            if (cells[y][x] == 3 or cells[y][x] == 6 or cells[y][x] == 7 or cells[y][x] == 9 or cells[y][x] == 11 or
                    cells[y][x] == 12 or cells[y][x] == 13 or cells[y1][x1] == 1 or cells[y1][x1] == 5 or cells[y1][
                        x1] == 8 or cells[y1][x1] == 9 or cells[y1][x1] == 11 or cells[y1][x1] == 13 or cells[y1][
                        x1] == 14):
                return (False)
            else:
                return (True)
